fn main() {
     ...
     println!("  1. Distinguish between computer and computer programing,/fn
     	       ...
     	       5. Conversant with computer programming concepts./n
     	       6. Navigate the career prospects in computer science.")
}